...
class Boldgrid_Inspirations_Inspiration extends Boldgrid_Inspirations {
	...
	public function add_pre_init_hooks() {
		...
		if ( false === is_network_admin() ) {
			...
			// When this plugin is activated, show the Welcome Panel, if not shown:
	...
	public function pre_add_hooks() {
		// If not an Administrator or the preview server, return; then do not load this section.
		// If on a network page, do not load this section.
