...
<div class="misc-pub-section boldgrid-auto-add-to-menu">
	In menu: <span id='selected-menu-names'></span>
	<a href="#edit-boldgrid-auto-add-to-menu" class="edit-boldgrid-auto-add-to-menu hide-if-no-js">
		<span aria-hidden="true"><?php echo esc_html__( 'Edit', 'boldgrid-inspirations' ); ?></span>
	</a>
	<div id="boldgrid-auto-add-to-menu-menu-listing" class="hide-if-js">
		<?php echo $nav_menus_html; ?>
		<p>
			<a class="hide-boldgrid-auto-add-to-menu button">OK</a>
			<a class="hide-boldgrid-auto-add-to-menu button-cancel" id="cancel-add-to-menu" href="#edit-boldgrid-auto-add-to-menu">Cancel</a>
		</p>
	</div>
