...
jQuery( document ).ready( function ($) {
	...
	$( "#start_over" ).change( function ( e ) {									 // Setup State Machine
		if ( ! e.currentTarget.checked ) {										 // If agree to start over gets deselected after user selects
		...
		} else {																 // Otherwise when agreement is checked
